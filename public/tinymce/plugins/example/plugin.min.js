tinymce.PluginManager.add('example', function (editor, url) {
  ...
  return {
    getMetadata: function () {
      return {
        name: pluginName,
        url: "http://tinymce.ax-z.cn/more-plugins/example.php",
      };
    }
  };
});
